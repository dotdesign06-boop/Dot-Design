          ...
          <div className="space-y-10 sm:space-y-12 md:space-y-16">
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  <div
                    className={`relative h-56 sm:h-64 md:h-auto ${
                  ...
                  <CardContent
                    className={`p-6 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-center ${
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                      ...
                      <h2 className="text-xl sm:text-2xl md:text-2xl lg:text-3xl font-bold">{service.title}</h2>
                    </div>

                    <p className="text-muted-foreground mb-5 sm:mb-6 text-base sm:text-base md:text-base lg:text-lg leading-relaxed">
                      {service.description}
                    </p>

                    <div className="mb-5 sm:mb-6">
                      <h3 className="font-semibold mb-3 sm:mb-3 text-base sm:text-base">What We Offer:</h3>
